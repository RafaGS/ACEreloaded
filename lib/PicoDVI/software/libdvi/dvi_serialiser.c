...
#if PICO_RP2040
#define pio_sm_set_pins_with_mask64(pio, sm, value, mask) pio_sm_set_pins_with_mask((pio), (sm), (uint32_t)(value), (uint32_t)(mask))
#define pio_sm_set_pindirs_with_mask64(pio, sm, value, mask) pio_sm_set_pindirs_with_mask((pio), (sm), (uint32_t)(value), (uint32_t)(mask))
#endif
